...
//                            .fill(Color("BG"))
                        ...
                        Circle()
                            .fill(Color("BG"))
                            .overlay {
                                AsyncImage(url: URL(string: "https://randomuser.me/api/portraits/women/54.jpg")) { phase in
                                    if let image = phase.image {
                                        ...
                                        Color("BG") // Indicates an error.
                                            .clipShape(Circle())
                                    } else {
                                        Color("BG")// Acts as a placeholder.
                                            .clipShape(Circle())
                                    }
                                }
                        ...
                        Text(pomodoroModel.timerStingValue)
    ...
    // MARK: Resubale Context Menu Options
    @ViewBuilder
